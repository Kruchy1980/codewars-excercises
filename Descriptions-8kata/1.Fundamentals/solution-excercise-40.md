...
#### Check if the string has the equal string by includes() methode which determines whether the string conrains character of specified string and returns boolean quantity.

    return s.includes('tree fiddy') || s.includes('three fifty') || s.includes('3.50');

}

#### More about includes() methode under link:
